...
DEFAULT_TEMPLATES: Dict[str, str] = {
    ...
    "reminder_24h": (
        "Напоминаем: собеседование запланировано на {slot_datetime_local}.\n"
        "Пожалуйста, отметьте время и убедитесь, что сможете подключиться вовремя."
    ),
    ...
    "reminder_1h": "⏰ Напоминание: собеседование через час — {dt_local}.",
