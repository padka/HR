...
DEFAULT_TEMPLATES: Dict[str, str] = {
    ...
    "manual_schedule_prompt": (
        ...
        "Чтобы ускорить назначение, напишите нам диапазон времени, когда вам удобно пройти онлайн собеседование. "
        "Например: 25.07 12:00-16:00 или завтра 10:00-13:00."
    ),
    "approved_msg": (
    ...
    "confirm_2h": (
        "⏰ Напоминание: собеседование через 2 часа — {dt_local}.\n"
        "Подтвердите участие, пожалуйста. Ссылка придёт после подтверждения."
    ),
    "att_confirmed_link": "🔗 Ссылка на Яндекс.Телемост: {link}\nВстречаемся {dt}",
    "att_declined": "Понимаю. Давайте подберём другое время.",
    "att_confirmed_ack": "Спасибо, будем вас ждать!",
    "result_fail": (
    ...
    "intro_day_reminder": (
        "⏰ Через 3 часа начнётся ознакомительный день ({slot_datetime_local}). "
        "Нажмите кнопку, чтобы подтвердить участие."
    ),
    ...
    "slot_proposal_candidate": (
        ...
        "Пожалуйста, подтвердите или выберите другое время."
    ),
    ...
    "reschedule_approved_candidate": "✅ Ваш запрос на перенос одобрен. Новое время собеседования: {new_time_local}.",
    "reschedule_declined_candidate": (
        "К сожалению, рекрутер не смог одобрить запрошенное вами время.\n"
        "Комментарий: {recruiter_comment}\n"
