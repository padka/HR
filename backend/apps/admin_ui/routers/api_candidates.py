...
router.add_api_route('/candidates/{candidate_id}/max-rollout/issue', api_misc.api_candidate_max_rollout_issue, methods=['POST'])
router.add_api_route('/candidates/{candidate_id}/max-launch-invite', api_misc.api_candidate_max_rollout_issue, methods=['POST'])
router.add_api_route('/candidates/{candidate_id}/max-rollout/revoke', api_misc.api_candidate_max_rollout_revoke, methods=['POST'])
router.add_api_route('/candidates/{candidate_id}/max-launch-invite/revoke', api_misc.api_candidate_max_rollout_revoke, methods=['POST'])
