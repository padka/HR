...
router.add_api_route('/candidates/hh/send-shared-portal', api_misc.api_candidates_hh_send_shared_portal, methods=['POST'])
...
router.add_api_route('/candidates/{candidate_id}/portal/restart', api_misc.api_candidate_portal_restart, methods=['POST'])
