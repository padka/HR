...
- Generated at: `2026-03-01T08:14:58.474013+00:00`
...
| --- | --- | --- | --- |
| `backend_security_regression` | `pass` | `10.8` | `/Users/mikhail/Projects/recruitsmart_admin/.venv/bin/pytest tests/test_admin_surface_hardening.py tests/test_calendar_hub_scope.py tests/test_perf_metrics_endpoint.py tests/test_admin_auth_no_basic_challenge.py tests/test_rate_limiting.py -q` |
| `backend_crud_regression` | `pass` | `14.8` | `/Users/mikhail/Projects/recruitsmart_admin/.venv/bin/pytest tests/test_admin_slots_api.py tests/test_admin_candidates_service.py -q` |
| `frontend_lint` | `pass` | `1.5` | `npm run lint` |
| `frontend_typecheck` | `pass` | `3.4` | `npm run typecheck` |
| `frontend_unit` | `pass` | `1.2` | `npm run test` |
| `frontend_build` | `pass` | `1.4` | `npm run build` |
| `frontend_e2e_gate` | `pass` | `28.8` | `npx playwright test tests/e2e/smoke.spec.ts tests/e2e/a11y.spec.ts tests/e2e/focus.cities.spec.ts tests/e2e/focus.slots.spec.ts tests/e2e/regression-flow.spec.ts` |
