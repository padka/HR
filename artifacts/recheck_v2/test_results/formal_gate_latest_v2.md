...
- Generated at: `2026-03-01T09:56:38.327694+00:00`
...
| --- | --- | --- | --- |
| `backend_security_regression` | `pass` | `12.6` | `/Users/mikhail/Projects/recruitsmart_admin/.venv/bin/pytest tests/test_admin_surface_hardening.py tests/test_calendar_hub_scope.py tests/test_perf_metrics_endpoint.py tests/test_admin_auth_no_basic_challenge.py tests/test_rate_limiting.py -q` |
| `backend_crud_regression` | `pass` | `16.2` | `/Users/mikhail/Projects/recruitsmart_admin/.venv/bin/pytest tests/test_admin_slots_api.py tests/test_admin_candidates_service.py -q` |
| `frontend_lint` | `pass` | `1.7` | `npm run lint` |
| `frontend_typecheck` | `pass` | `3.8` | `npm run typecheck` |
| `frontend_unit` | `pass` | `1.5` | `npm run test` |
| `frontend_build` | `pass` | `1.5` | `npm run build` |
