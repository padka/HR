...
- Generated at: `2026-03-01T11:36:08.303952+00:00`
...
| --- | --- | --- | --- |
| `backend_security_regression` | `pass` | `12.5` | `/Users/mikhail/Projects/recruitsmart_admin/.venv/bin/pytest tests/test_admin_surface_hardening.py tests/test_calendar_hub_scope.py tests/test_perf_metrics_endpoint.py tests/test_admin_auth_no_basic_challenge.py tests/test_rate_limiting.py -q` |
...
| `frontend_typecheck` | `pass` | `4.0` | `npm run typecheck` |
| `frontend_unit` | `pass` | `1.6` | `npm run test` |
| `frontend_build` | `pass` | `1.7` | `npm run build` |
| `frontend_e2e_gate` | `pass` | `29.3` | `npx playwright test tests/e2e/smoke.spec.ts tests/e2e/a11y.spec.ts tests/e2e/focus.cities.spec.ts tests/e2e/focus.slots.spec.ts tests/e2e/regression-flow.spec.ts` |
