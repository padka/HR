...
| `ReminderService.schedule_for_slot(slot_id, skip_confirmation_prompts=False)` | Строит расписание `<confirm_6h, confirm_3h, confirm_2h>`, сохраняет в `slot_reminder_jobs`, отменяет прошедшие задания. |
